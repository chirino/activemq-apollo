...
class SessionResource extends Resource {
  ...
  def get_signin_html(@Context response:HttpServletResponse,
                      @ApiParam(value = "User Name", defaultValue="admin") @QueryParam("username") username:String,
                      @ApiParam(value = "User Password", defaultValue="password") @QueryParam("password") password:String,
                      @ApiParam(value = "On success, redirect to the specified URL", defaultValue = "/") @QueryParam("target") target:String
                             ): ErrorDTO = {
  ...
  def post_signin(@Context response:HttpServletResponse,
                  @ApiParam(value = "User Name") @FormParam("username") username:String,
                  @ApiParam(value = "User Password") @FormParam("password") password:String):Boolean =  {
    try {
